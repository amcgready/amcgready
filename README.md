...
- [Scanly](https://github.com/amcgready/Scanly) &mdash; Scanly is a media file organizer that monitors directories for new files and creates an organized library using symbolic links. 
- [BeatMapper](https://github.com/amcgready/BeatMapper) &mdash; A dedicated tool for creating, editing, and visualizing custom beat maps exclusively for Drums Rock, featuring advanced audio analysis and an interactive editor.

---

<!--
**amcgready/amcgready** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
